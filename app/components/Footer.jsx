      ...
      <div className="footer_component">
        <div className="padding-global">
          <div className="container-large">
            <div className="footer_component-wrapper">
              <div
                id="w-node-_106bf4f1-d42d-5bde-bdbc-a6b3203f56de-203f56d9"
                className="footer_component-access row-span-1 col-span-2"
              >
                ...
                >
                  <div>Sign up now</div>
                  <img
                    src="https://cdn.prod.website-files.com/6771bbc3c3d06393fbfdb57e/677277e9df18e423cbd2f76a_vector%20(6).svg"
                    loading="lazy"
                    alt=""
                  />
                </a>
              ...
              <div
                id="w-node-_106bf4f1-d42d-5bde-bdbc-a6b3203f56e5-203f56d9"
                className="footer_component-links"
              >
                <a
                  href="https://www.linkedin.com/company/arcade-ai/"
                  target="_blank"
                  className="footer_component-link w-inline-block"
                >
                ...
                >
                  ...
                  <div>Github</div>
                  <div className="github_numbers-wrapper">
                    <img
                      src="https://cdn.prod.website-files.com/6771bbc3c3d06393fbfdb57e/678962153b7785297bc88076_star,%20favorite,%20award.svg"
                      loading="lazy"
                      alt=""
                    />
                    <div className="stargazers">276</div>
                  </div>
                </a>
                <a
                  href="https://x.com/TryArcade"
                  target="_blank"
                  className="footer_component-link w-inline-block"
                >
                  <div className="icon-1x1-xsmall w-embed">
                ...
                >
                  <img
                    src="https://cdn.prod.website-files.com/6771bbc3c3d06393fbfdb57e/679921626b4f13b501727d0b_636e0a6cc3c481a15a141738_icon_clyde_white_RGB.png"
                    loading="lazy"
                    alt=""
                    className="image-3"
                  />
        ...
        <div className="padding-global">
          <div className="container-large">
            <div className="footer_bottom-wrapper">
              <div className="text-size-body4 text-color-white">
                <span>©️</span> 2025 - Arcade AI, Inc
              </div>
              <div className="footer_bottom-links_wrapper">
                <a href="/pricing" className="footer_link w-inline-block">
                  <div className="text-size-body4">Pricing</div>
                </a>
                <a
                  href="https://docs.arcade-ai.com/home"
                  target="_blank"
                  className="footer_link w-inline-block"
                >
                  <div className="text-size-body4">Docs</div>
                </a>
                <a href="/privacy" className="footer_link w-inline-block">
                  <div className="text-size-body4">Privacy Policy</div>
                </a>
                <a href="/terms" className="footer_link w-inline-block">
                  <div className="text-size-body4">Terms of Service</div>
                </a>
              </div>
            </div>
          </div>
